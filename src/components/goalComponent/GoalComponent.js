  ...
  return (
    <div className="goalComponent">
      ...
      <div className="goalComponent__bar">
        <BarComponent actualValue={props.goalActualValue} endValue={props.goalEndValue} />
      </div>

      {showMore && (
        <div>
          <div className="goalComponent__description">
            {props.goalDesc}
          </div>
          <div className="goalComponent__goalValue">
            <span>Wartość końcowa:</span>
            <span className="goalComponent__goalValue__value">{props.goalEndValue}</span>
          </div>
          <div className="goalComponent__goalValue">
            <span>Wartość aktualna:</span>
            <span className="goalComponent__goalValue__value">{props.goalActualValue}</span>
          </div>
        </div>
      )}
    </div>
